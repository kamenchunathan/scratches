...
impl RocFunction_82 {
    pub fn force_thunk(mut self, arg0: Event) -> u32 {
        extern "C" {
            fn roc__main_for_host_0_caller(arg0: *const Event, closure_data: *mut u8, output: *mut u32);
        }
...
pub fn handle_callback_for_host(arg0: u32) -> () {
    extern "C" {
        fn roc__handle_callback_for_host_1_exposed_generic(_: *mut (), _: u32);
    }
